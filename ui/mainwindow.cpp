...
//        ui->shapeParameterSlider3, ui->shapeParameterTextbox3, settings.shapeParameter3, 1.f, 100.f))
    ...
    BIND(FloatBinding::bindSliderAndTextbox(ui->kCollisionSlider, ui->kCollision, settings.kCollision, 0, 2000));
    BIND(FloatBinding::bindSliderAndTextbox(ui->dCollisionSlider, ui->dCollision, settings.dCollision, 0, 2000));
